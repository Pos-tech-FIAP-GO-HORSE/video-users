...
func (_m *IUserService) Create(ctx context.Context, user *entity.User) (*entity.User, error) {
...
func (_m *IUserService) Login(ctx context.Context, email string, password string) (string, error) {
